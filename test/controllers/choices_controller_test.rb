...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { is_answer: @choice.is_answer, name: @choice.name, word_id: @choice.word_id } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { is_answer: @choice.is_answer, name: @choice.name, word_id: @choice.word_id } }
